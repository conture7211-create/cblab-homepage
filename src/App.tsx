...
function ContactPage() {
  return (
    <main className="m-0 block w-full p-0">
      <div className="pt-[120px] md:pt-[140px] lg:pt-[156px]">
        <FinalContact />
      </div>
    </main>
  );
  ...
  return (
    <Routes>
      <Route element={<RootLayout />}>
        ...
        <Route path="product" element={<Navigate to="/brands/divaline" replace />} />
        <Route path="education" element={<Navigate to="/business/professional-education" replace />} />
        <Route path="technology" element={<Navigate to="/technology/development" replace />} />
        <Route path="global" element={<Navigate to="/brands/brand-platform/partnership" replace />} />
      </Route>
    </Routes>
  );
}

export default App;import { Routes, Route, Outlet } from 'react-router-dom';
import TechnologySection from './components/TechnologySection';
import BrandsSection from './components/BrandsSection';
import AboutUsSection from './components/AboutUsSection';
import Navbar from './components/Navbar';
