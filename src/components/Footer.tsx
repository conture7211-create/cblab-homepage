      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-white/10 pb-12 gap-8">
          ...
          <div className="grid grid-cols-2 gap-12 font-sans text-sm">
            ...
            <ul>
              <li className="mb-4"><a href="#brands" className="hover:text-gold transition-colors uppercase tracking-widest text-xs">Brands</a></li>
              <li className="mb-4"><a href="#global" className="hover:text-gold transition-colors uppercase tracking-widest text-xs">Global</a></li>
              <li><a href="#contact" className="hover:text-gold transition-colors uppercase tracking-widest text-xs">Contact</a></li>
            </ul>
          </div>
        </div>
