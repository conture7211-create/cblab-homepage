...
const ctaGhost =
  'inline-flex min-h-[48px] items-center justify-center border border-white/40 bg-white/[0.06] px-8 py-3 text-[12px] font-semibold tracking-[0.14em] text-elegant-white backdrop-blur-[2px] transition hover:border-[#d8c1a0]/55 hover:bg-white/10 md:text-[13px]';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-32 items-start mb-32">
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <a href="mailto:info@cnb-lab.com" className={ctaGhost}>
                Contact / Partnership
              </a>
              <a
