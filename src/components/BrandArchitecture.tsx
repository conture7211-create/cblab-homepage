    ...
    <section id="architecture" className="py-32 lg:py-56 bg-deep-black text-warm-ivory relative overflow-hidden">
      <div className="container mx-auto px-8 md:px-16 mb-24 lg:mb-32 text-center">
        ...
        <motion.h2 
          ...
          className="font-serif text-[44px] lg:text-[64px] text-elegant-white tracking-tight leading-[1.2]"
        >
          통합된 구조, 확장하는 브랜드
        </motion.h2>
      </div>
        ...
        <div className="flex flex-col space-y-16 lg:space-y-40 relative">
          ...
          >
            ...
            <div className="relative z-20 w-full lg:w-1/2 p-12 md:p-20 lg:p-32">
              ...
              <h3 className="font-serif text-[40px] md:text-[56px] lg:text-[64px] text-elegant-white mb-10 leading-[1.1]">C&B Lab</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 relative">
            ...
            >
              ...
              <div className="relative z-20 p-12 lg:p-20">
                ...
                <h3 className="font-serif text-[40px] lg:text-[56px] text-elegant-white mb-8 leading-[1.1]">DIVALINE</h3>
                <p className="font-sans text-[16px] md:text-[18px] text-soft-stone leading-[2] font-light break-keep max-w-[480px]">
            ...
            >
              ...
              <div className="relative z-20 p-12 lg:p-20">
                ...
                <h3 className="font-serif text-[40px] lg:text-[48px] text-elegant-white mb-8 uppercase tracking-widest leading-[1.2]">LONG-TIME-LINER</h3>
                <p className="font-sans text-[16px] md:text-[18px] text-soft-stone leading-[2] font-light break-keep max-w-[480px]">
